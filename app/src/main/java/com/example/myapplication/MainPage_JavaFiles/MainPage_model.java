...
public class MainPage_model {
    String uid, owner, approved,title,Description, image, teacherName;

    public MainPage_model(){
    }

    public MainPage_model(String uid, String owner, String approved, String title, String Description, String image, String teacherName){
        this.uid = uid;
        this.owner = owner;
